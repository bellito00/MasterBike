...
urlpatterns = [
    ...
    path('mantenciontecnico/', mantenciontecnico, name='mantenciontecnico'),
    path('modificartecnico/<id>/', modificartecnico, name='modificartecnico'),
    path('eliminarmantenciontecnico/<id>/', eliminarmantenciontecnico, name='eliminarmantenciontecnico'),
